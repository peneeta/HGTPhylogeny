...
* [query_entrez.ipynb](query_entrez.ipynb) - example query for how the CDS data was obtained from the NCBI database.
* [intragenic_conflict directory](intragenic_conflict) - contains the treefiles constructed using a sliding window approach described in Smith et al. (https://academic.oup.com/mbe/article/37/11/3380/5870841). Shell commands used to generate these outputs are provided in [intragenic_conflict.sh](intragenic_conflict.sh)
